...
The Swift package SHALL send supported commands for BLUETTI switch-style and select-style states and SHALL reject values that are not allowed by the current decoded control metadata.

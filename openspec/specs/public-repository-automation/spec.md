# public-repository-automation Specification

## Purpose
Define the public repository automation, contributor intake templates, and project metadata contract for the standalone Python, local web, and Swift surfaces.

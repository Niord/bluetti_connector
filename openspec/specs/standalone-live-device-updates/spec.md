# standalone-live-device-updates Specification

## Purpose
Define the backend-owned BLUETTI websocket lifecycle and local browser-facing live update stream contract for the standalone runtime.

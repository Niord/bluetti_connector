# public-repository-documentation Specification

## Purpose
Define the public documentation, attribution, and repository-navigation contract for publishing the mixed Python, local web, Swift package, and macOS sample project.
...
- **THEN** public documentation links to the official upstream repository and describes the local extraction or adaptation boundary without requiring internal agent context files

### Requirement: Module Setup Instructions Are Separated
The repository SHALL provide separate setup and verification instructions for the Python or backend runtime, the backend-served local web page, the Swift package, and the macOS sample app.

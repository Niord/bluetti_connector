# standalone-browser-oauth-session Specification

## Purpose
Define the standalone backend contract for backend-managed BLUETTI browser OAuth start, callback validation, authorization-code exchange, and local session bootstrap.
